...
events <- read_excel(here('List of MVCO cruises for NES-LTER project 20230118.xlsx'), sheet = 1, skip = 6)
...
# remove rows after 2022-05-06 and columns for MVCO event number and Google Drive links
events <- events[-c(82:86),-c(2,6)]

# update new Ryan Marine boat?

# rename cols to lowercase
colnames(events)[11] <- "bucket_sample"
colnames(events)[12] <- "bongo_or_other_net"

# rename Notes to comment
colnames(events)[13] <- "comment"
...
excel_to_template(here('List of MVCO cruises for NES-LTER project 20230118'), 'nes-lter-events-mvco', rights='CC0')

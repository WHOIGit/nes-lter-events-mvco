...
events <- read_excel(here('List of MVCO cruises for NES-LTER project 20250523.xlsx'), sheet = 1, skip = 6)
...
excel_to_template(here('List of MVCO cruises for NES-LTER project 20250523'), 'nes-lter-events-mvco', rights='CC0')

...
events <- read_excel(here('List of MVCO cruises for NES-LTER project 20230208.xlsx'), sheet = 1, skip = 6)
...
excel_to_template(here('List of MVCO cruises for NES-LTER project 20230208'), 'nes-lter-events-mvco', rights='CC0')
